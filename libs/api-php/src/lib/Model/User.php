...
class User implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['phone_number']) && (mb_strlen($this->container['phone_number']) > 2147483647)) {
            $invalidProperties[] = "invalid value for 'phone_number', the character length must be smaller than or equal to 2147483647.";
        }
        ...
        if (!is_null($this->container['mobile']) && (mb_strlen($this->container['mobile']) > 100)) {
            $invalidProperties[] = "invalid value for 'mobile', the character length must be smaller than or equal to 100.";
        }
        ...
        if (!is_null($this->container['referral_code']) && (mb_strlen($this->container['referral_code']) < 0)) {
            $invalidProperties[] = "invalid value for 'referral_code', the character length must be bigger than or equal to 0.";
        }
    ...
    public function setFirstname($firstname)
    {
        ...
        if (!is_null($firstname) && (mb_strlen($firstname) < 0)) {
            throw new \InvalidArgumentException('invalid length for $firstname when calling User., must be bigger than or equal to 0.');
        }
    ...
    public function setLastname($lastname)
    {
        ...
        if (!is_null($lastname) && (mb_strlen($lastname) < 0)) {
            throw new \InvalidArgumentException('invalid length for $lastname when calling User., must be bigger than or equal to 0.');
        }
    ...
    {
        if (!is_null($phone_number) && (mb_strlen($phone_number) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling User., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($phone_number) && (mb_strlen($phone_number) < 0)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling User., must be bigger than or equal to 0.');
        }
    ...
    {
        if (!is_null($mobile) && (mb_strlen($mobile) > 100)) {
            throw new \InvalidArgumentException('invalid length for $mobile when calling User., must be smaller than or equal to 100.');
        }
        if (!is_null($mobile) && (mb_strlen($mobile) < 0)) {
            throw new \InvalidArgumentException('invalid length for $mobile when calling User., must be bigger than or equal to 0.');
        }
    ...
    public function setReferralCode($referral_code)
    {
        if (!is_null($referral_code) && (mb_strlen($referral_code) > 50)) {
            throw new \InvalidArgumentException('invalid length for $referral_code when calling User., must be smaller than or equal to 50.');
        }
        if (!is_null($referral_code) && (mb_strlen($referral_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $referral_code when calling User., must be bigger than or equal to 0.');
        }
