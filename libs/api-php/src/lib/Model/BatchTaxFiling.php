...
/**
 * BatchTaxFiling Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BatchTaxFiling implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BatchTaxFiling';
    ...
    public function setClaimDate($claim_date)
    {
        ...
        if ((mb_strlen($claim_date) < 1)) {
            throw new \InvalidArgumentException('invalid length for $claim_date when calling BatchTaxFiling., must be bigger than or equal to 1.');
        }
    ...
    public function setCreatedOn($created_on)
    {
        ...
        if ((mb_strlen($created_on) < 1)) {
            throw new \InvalidArgumentException('invalid length for $created_on when calling BatchTaxFiling., must be bigger than or equal to 1.');
        }
    ...
    public function setModifiedOn($modified_on)
    {
        ...
        if ((mb_strlen($modified_on) < 1)) {
            throw new \InvalidArgumentException('invalid length for $modified_on when calling BatchTaxFiling., must be bigger than or equal to 1.');
        }
