...
/**
 * ChartOfAccount Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ChartOfAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChartOfAccount';
    ...
    protected static $setters = [
        ...
        'petty_cash' => 'setPettyCash',
        'cheque' => 'setCheque',
        'credit_card' => 'setCreditCard',
        'other_channels' => 'setOtherChannels',
        'system_chart_of_account' => 'setSystemChartOfAccount'
    ];
    ...
    protected static $getters = [
        ...
        'petty_cash' => 'getPettyCash',
        'cheque' => 'getCheque',
        'credit_card' => 'getCreditCard',
        'other_channels' => 'getOtherChannels',
        'system_chart_of_account' => 'getSystemChartOfAccount'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['is_lock'] = $data['is_lock'] ?? false;
        ...
        $this->container['petty_cash'] = $data['petty_cash'] ?? null;
        $this->container['cheque'] = $data['cheque'] ?? null;
        $this->container['credit_card'] = $data['credit_card'] ?? null;
        $this->container['other_channels'] = $data['other_channels'] ?? null;
        $this->container['system_chart_of_account'] = $data['system_chart_of_account'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['createdon']) < 1)) {
            $invalidProperties[] = "invalid value for 'createdon', the character length must be bigger than or equal to 1.";
        }

        if ($this->container['modifiedon'] === null) {
            $invalidProperties[] = "'modifiedon' can't be null";
        }
        if ((mb_strlen($this->container['modifiedon']) < 1)) {
            $invalidProperties[] = "invalid value for 'modifiedon', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setCode($code)
    {
        if (!is_null($code) && (mb_strlen($code) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code when calling ChartOfAccount., must be smaller than or equal to 50.');
        }
        if (!is_null($code) && (mb_strlen($code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $code when calling ChartOfAccount., must be bigger than or equal to 0.');
        }
    ...
    public function setCreatedon($createdon)
    {
        ...
        if ((mb_strlen($createdon) < 1)) {
            throw new \InvalidArgumentException('invalid length for $createdon when calling ChartOfAccount., must be bigger than or equal to 1.');
        }
    ...
    public function setModifiedon($modifiedon)
    {
        ...
        if ((mb_strlen($modifiedon) < 1)) {
            throw new \InvalidArgumentException('invalid length for $modifiedon when calling ChartOfAccount., must be bigger than or equal to 1.');
        }
     ...
     * Gets petty_cash
     *
     * @return OneOfPettyCash|null
     */
    public function getPettyCash()
    {
        return $this->container['petty_cash'];
    }

    /**
     * Sets petty_cash
     *
     * @param OneOfPettyCash|null $petty_cash petty_cash
     *
     * @return self
     */
    public function setPettyCash($petty_cash)
    {
        $this->container['petty_cash'] = $petty_cash;
     ...
     * Gets cheque
     *
     * @return OneOfCheque|null
     */
    public function getCheque()
    {
        return $this->container['cheque'];
    }

    /**
     * Sets cheque
     *
     * @param OneOfCheque|null $cheque cheque
     *
     * @return self
     */
    public function setCheque($cheque)
    {
        $this->container['cheque'] = $cheque;
     ...
     * Sets credit_card
     *
     * @param OneOfCreditCard|null $credit_card credit_card
     *
     * @return self
     */
     ...
     * Gets other_channels
     *
     * @return OneOfOtherChannels|null
     */
    public function getOtherChannels()
    {
        return $this->container['other_channels'];
    }

    /**
     * Sets other_channels
     *
     * @param OneOfOtherChannels|null $other_channels other_channels
     *
     * @return self
     */
    public function setOtherChannels($other_channels)
    {
        $this->container['other_channels'] = $other_channels;

        return $this;
    }

    /**
     * Gets system_chart_of_account
     *
     * @return OneOfSystemChartOfAccount|null
     */
    public function getSystemChartOfAccount()
    {
        return $this->container['system_chart_of_account'];
    }

    /**
     * Sets system_chart_of_account
     *
     * @param OneOfSystemChartOfAccount|null $system_chart_of_account system_chart_of_account
     *
     * @return self
     */
    public function setSystemChartOfAccount($system_chart_of_account)
    {
        $this->container['system_chart_of_account'] = $system_chart_of_account;
