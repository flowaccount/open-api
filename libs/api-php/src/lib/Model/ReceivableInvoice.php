...
/**
 * ReceivableInvoice Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ReceivableInvoice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReceivableInvoice';
    ...
    public function setCreatedOn($created_on)
    {
        ...
        if ((mb_strlen($created_on) < 1)) {
            throw new \InvalidArgumentException('invalid length for $created_on when calling ReceivableInvoice., must be bigger than or equal to 1.');
        }
    ...
    public function setModifiedOn($modified_on)
    {
        ...
        if ((mb_strlen($modified_on) < 1)) {
            throw new \InvalidArgumentException('invalid length for $modified_on when calling ReceivableInvoice., must be bigger than or equal to 1.');
        }
    ...
    public function setPublishedOn($published_on)
    {
        ...
        if ((mb_strlen($published_on) < 1)) {
            throw new \InvalidArgumentException('invalid length for $published_on when calling ReceivableInvoice., must be bigger than or equal to 1.');
        }
    ...
    public function setDocumentDate($document_date)
    {
        ...
        if ((mb_strlen($document_date) < 1)) {
            throw new \InvalidArgumentException('invalid length for $document_date when calling ReceivableInvoice., must be bigger than or equal to 1.');
        }
