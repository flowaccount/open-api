 ...
 */
class ExpenseList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExpenseList';
    ...
    public function setBankAccountNumber($bank_account_number)
    {
        if (!is_null($bank_account_number) && (mb_strlen($bank_account_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $bank_account_number when calling ExpenseList., must be smaller than or equal to 50.');
        }
        if (!is_null($bank_account_number) && (mb_strlen($bank_account_number) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bank_account_number when calling ExpenseList., must be bigger than or equal to 0.');
        }
    ...
    public function setCheckNumber($check_number)
    {
        if (!is_null($check_number) && (mb_strlen($check_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $check_number when calling ExpenseList., must be smaller than or equal to 50.');
        }
        if (!is_null($check_number) && (mb_strlen($check_number) < 0)) {
            throw new \InvalidArgumentException('invalid length for $check_number when calling ExpenseList., must be bigger than or equal to 0.');
        }
    ...
    public function setCheckBankId($check_bank_id)
    {
        if (!is_null($check_bank_id) && (mb_strlen($check_bank_id) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $check_bank_id when calling ExpenseList., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($check_bank_id) && (mb_strlen($check_bank_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $check_bank_id when calling ExpenseList., must be bigger than or equal to 0.');
        }
    ...
    public function setTransferBankId($transfer_bank_id)
    {
        if (!is_null($transfer_bank_id) && (mb_strlen($transfer_bank_id) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $transfer_bank_id when calling ExpenseList., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($transfer_bank_id) && (mb_strlen($transfer_bank_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $transfer_bank_id when calling ExpenseList., must be bigger than or equal to 0.');
        }
    ...
    public function setExternalDocumentId($external_document_id)
    {
        if (!is_null($external_document_id) && (mb_strlen($external_document_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $external_document_id when calling ExpenseList., must be smaller than or equal to 36.');
        }
    ...
    public function setBatchId($batch_id)
    {
        if (!is_null($batch_id) && (mb_strlen($batch_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $batch_id when calling ExpenseList., must be smaller than or equal to 36.');
        }
