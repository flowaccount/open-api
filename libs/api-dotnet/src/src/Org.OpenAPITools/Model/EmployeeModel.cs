...
namespace Org.OpenAPITools.Model
{
    ...
    /// EmployeeModel
    /// </summary>
    [DataContract(Name = "EmployeeModel")]
    public partial class EmployeeModel : IEquatable<EmployeeModel>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as EmployeeModel);
        }

        /// <summary>
        /// Returns true if EmployeeModel instances are equal
        /// </summary>
        /// <param name="input">Instance of EmployeeModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmployeeModel input)
        {
            if (input == null)
            {
                return false;
