...
namespace Org.OpenAPITools.Model
{
    ...
    /// ReceivableInvoice
    /// </summary>
    [DataContract(Name = "ReceivableInvoice")]
    public partial class ReceivableInvoice : IEquatable<ReceivableInvoice>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ReceivableInvoice" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ReceivableInvoice() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ReceivableInvoice" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReceivableInvoice {\n");
        ...
        {
            return this.Equals(input as ReceivableInvoice);
        }

        /// <summary>
        /// Returns true if ReceivableInvoice instances are equal
        /// </summary>
        /// <param name="input">Instance of ReceivableInvoice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReceivableInvoice input)
        {
            if (input == null)
            {
                return false;
