...
namespace Org.OpenAPITools.Model
{
    ...
    /// ExpenseList
    /// </summary>
    [DataContract(Name = "ExpenseList")]
    public partial class ExpenseList : IEquatable<ExpenseList>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpenseList" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ExpenseList);
        }

        /// <summary>
        /// Returns true if ExpenseList instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpenseList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpenseList input)
        {
            if (input == null)
            {
                return false;
