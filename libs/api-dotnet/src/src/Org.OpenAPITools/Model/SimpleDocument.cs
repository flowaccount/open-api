...
namespace Org.OpenAPITools.Model
{
    ...
    /// SimpleDocument
    /// </summary>
    [DataContract(Name = "SimpleDocument")]
    public partial class SimpleDocument : IEquatable<SimpleDocument>, IValidatableObject
    {
        /// <summary>
        ...
        public SimpleDocument(long recordId = default(long), string contactCode = default(string), string contactName = default(string), string contactAddress = default(string), string contactTaxId = default(string), string contactBranch = default(string), string contactPerson = default(string), string contactEmail = default(string), string contactNumber = default(string), string contactZipCode = default(string), int contactGroup = default(int), DateTime publishedOn = default(DateTime), int creditType = default(int), int creditDays = default(int), DateTime dueDate = default(DateTime), string salesName = default(string), string projectName = default(string), string reference = default(string), bool isVatInclusive = default(bool), bool useReceiptDeduction = default(bool), decimal subTotal = default(decimal), int discountPercentage = default(int), decimal discountAmount = default(decimal), decimal totalAfterDiscount = default(decimal), bool isVat = default(bool), decimal vatAmount = default(decimal), decimal grandTotal = default(decimal), bool documentShowWithholdingTax = default(bool), int documentWithholdingTaxPercentage = default(int), decimal documentWithholdingTaxAmount = default(decimal), int documentDeductionType = default(int), decimal documentDeductionAmount = default(decimal), string remarks = default(string), string internalNotes = default(string), bool showSignatureOrStamp = default(bool), string documentStructureType = default(string), string externalId = default(string), string saleAndPurchaseChannel = default(string), string rowIndex = default(string), List<SimpleProductItem> items = default(List<SimpleProductItem>), List<UpgradeDocument> documentReference = default(List<UpgradeDocument>), decimal? exemptAmount = default(decimal?))
        {
