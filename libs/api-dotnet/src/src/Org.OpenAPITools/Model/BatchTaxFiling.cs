...
namespace Org.OpenAPITools.Model
{
    ...
    /// BatchTaxFiling
    /// </summary>
    [DataContract(Name = "BatchTaxFiling")]
    public partial class BatchTaxFiling : IEquatable<BatchTaxFiling>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchTaxFiling" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BatchTaxFiling() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchTaxFiling" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BatchTaxFiling {\n");
        ...
        {
            return this.Equals(input as BatchTaxFiling);
        }

        /// <summary>
        /// Returns true if BatchTaxFiling instances are equal
        /// </summary>
        /// <param name="input">Instance of BatchTaxFiling to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BatchTaxFiling input)
        {
            if (input == null)
            {
                return false;
