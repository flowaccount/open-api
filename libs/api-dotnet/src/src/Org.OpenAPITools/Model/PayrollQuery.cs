...
namespace Org.OpenAPITools.Model
{
    ...
    /// PayrollQuery
    /// </summary>
    [DataContract(Name = "PayrollQuery")]
    public partial class PayrollQuery : IEquatable<PayrollQuery>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PayrollQuery" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PayrollQuery);
        }

        /// <summary>
        /// Returns true if PayrollQuery instances are equal
        /// </summary>
        /// <param name="input">Instance of PayrollQuery to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayrollQuery input)
        {
            if (input == null)
            {
                return false;
