...
namespace Org.OpenAPITools.Test.Model
{
    ...
    public class SimpleDocumentTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" SimpleDocument
            //Assert.IsType<SimpleDocument>(instance);
        }
