...
describe 'PurchaseOrderApi' do
  ...
  # unit tests for purchase_order_change_status_by_key
  ...
  # @return [File]
  describe 'purchase_order_change_status_by_key test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for purchase_order_create
  # To Create a document with SimpleDocument as the parameter
  # @param culture 
  # @param simple_document 
  # @param [Hash] opts the optional parameters
  # @return [MessageSent]
  describe 'purchase_order_create test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for purchase_order_create2
  # To Create a document with InlineDocument as the parameter
  # @param culture 
  # @param inline_document 
  # @param [Hash] opts the optional parameters
  # @return [MessageSent]
  describe 'purchase_order_create2 test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for purchase_order_delete
  # To delete the document given a list of documentids
  # @param id 
  # @param culture 
  # @param [Hash] opts the optional parameters
  # @return [File]
  describe 'purchase_order_delete test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for purchase_order_details
  # To get details of a document
  # @param id Sql DocumentId
  # @param culture 
  # @param [Hash] opts the optional parameters
  # @return [File]
  describe 'purchase_order_details test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for purchase_order_edit
  ...
  # @param [Hash] opts the optional parameters
  # @return [File]
  describe 'purchase_order_edit test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for purchase_order_edit2
  ...
  # @param [Hash] opts the optional parameters
  # @return [File]
  describe 'purchase_order_edit2 test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for purchase_order_index
  ...
  # @return [File]
  describe 'purchase_order_index test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for purchase_order_receive_payment
  ...
  # @param [Hash] opts the optional parameters
  # @return [File]
  describe 'purchase_order_receive_payment test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
