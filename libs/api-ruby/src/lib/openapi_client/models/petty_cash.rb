...
module OpenapiClient
  class PettyCash
    ...
    attr_accessor :cash_holder_id

    attr_accessor :cash_holder

    attr_accessor :status

    attr_accessor :cash_holder_name
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PettyCash` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PettyCash`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'cash_holder_id')
        self.cash_holder_id = attributes[:'cash_holder_id']
      end

      if attributes.key?(:'cash_holder')
        self.cash_holder = attributes[:'cash_holder']
      end
      ...
      if attributes.key?(:'cash_holder_name')
        self.cash_holder_name = attributes[:'cash_holder_name']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          cash_holder_id == o.cash_holder_id &&
          cash_holder == o.cash_holder &&
          status == o.status &&
          cash_holder_name == o.cash_holder_name &&
    ...
    def hash
      [id, company_id, created_on, modified_on, is_delete, description, name, cash_limit, chart_of_account_id, chart_of_account, cash_holder_id, cash_holder, status, cash_holder_name, remaining_balance].hash
    end
